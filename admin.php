...
if (!isset($_SESSION['admin']) || empty($_SESSION['admin']['email'])) {
    ...
    require_once('lib/add&delcomments.php');
}
?>

<!-- Ajouter un administrateur -->
<section>
    <h1 class="titleadmin text-center">Ajouter ou supprimer un administrateur</h1>
    ...
    <h4 class="titleadmin text-center">Supprimer un administrateur</h4>
    <form method="POST" enctype="multipart/form-data">
    <div class="mb-3">
    ...
    <!-- Supprimer une pizza -->
    <h4 class="titleadmin text-center">Supprimer une pizza</h4>
    <form method="POST" enctype="multipart/form-data">
    <div class="mb-3">
    ...
    <h4 class="titleadmin text-center">Supprimer un commentaire</h4>
    <form method="POST" enctype="multipart/form-data">
        <div class="mb-3">
